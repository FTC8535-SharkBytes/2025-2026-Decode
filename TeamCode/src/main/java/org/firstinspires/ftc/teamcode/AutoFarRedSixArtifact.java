...
/** @noinspection unused*/
@Autonomous(name="AutoFarRedSixArtifact", group="Autonomous", preselectTeleOp = "RedTeleop")
public class AutoFarRedSixArtifact extends LinearOpMode {
            ...
            switch (stateMachine) {
                case READ_LIMELIGHT:
                    if (runtime.seconds() > 1.0) {
                        ...
                        limelightController.switchPipeline(2);
